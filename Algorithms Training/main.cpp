...
int main(){
    ...
    std::cout << EuclideanAlgorithm::euclidean_algorithm(48, 9) << std::endl;
    std::cout << EuclideanSimpleAlgorithm::euclidean_simple_algorithm(48, 9) << std::endl; // incorrect
    std::cout << EuclideanFastAlgorithm::euclidean_fast_algorithm(48, 9) << std::endl;
    return 0;
}
